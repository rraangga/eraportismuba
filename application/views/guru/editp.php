      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open_multipart('guru/guruedit'); ?>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group pt-3">
                  <label for="username">Guru Mapel</label>
                  <small class="form-text text-danger"><?= form_error('mapel'); ?></small>
                  <?php foreach($mapel as $m): ?>
                  <input type="text" class="form-control" id="mapel" name="mapel" value="<?= $m['mapel'];?>" disabled>
                  <?php endforeach; ?>
                </div>
            ...
            <div class="card-footer">
              <a href="<?= base_url('guru');?>" class="btn btn-secondary">Back</a>

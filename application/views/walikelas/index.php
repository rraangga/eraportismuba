    ...
    <div class="row pl-lg-4">
      ...
      <div class=" card col-md-6">
              ...
              <div class="col">
                <div class="card-body">
                  <div class="list-group">
                    ...
                    <?php endforeach; ?>
                    <h5 class="card-title text-bold text-uppercase">Wali Kelas : </h5>
                    <?php foreach ($kelasw as $kw): ?>
                    <h5 class="card-title ml-2 text-muted"><?= $kw['kelas']; ?></h5>
                    <?php endforeach; ?>
                  </div>
                </div>
              </div>
        ...
        <div class="card-footer">
          ...
          <a class="btn btn-success float-right" href="<?= base_url('walikelas/waliedit'); ?>"><i
